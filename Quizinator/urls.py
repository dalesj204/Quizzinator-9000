...
urlpatterns = [
    ...
    path('class_list/', views.ClassListRedirectView, name='classes_redirect'),
    path('class_list/student/', views.ClassListViewStudent.as_view(), name='classes_student'),
    path('class_list/teacher/', views.ClassListViewTeacher.as_view(), name='classes_teacher'),
